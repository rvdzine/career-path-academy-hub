...
const Blog = () => {
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt:
        "Learn how video content can transform your digital marketing efforts and engage your audience more effectively.",
      author: "Priya Patel",
      date: "2024-01-12",
      readTime: "7 min read",
    ...
    },
    {
      ...
      excerpt:
        "Stay ahead of the curve with these emerging social media trends that every marketer should know about.",
      author: "Rahul Kumar",
      date: "2024-01-10",
      readTime: "6 min read",
    ...
    },
    {
      ...
      excerpt:
        "Maximize your email marketing ROI with these proven strategies and techniques that drive conversions.",
      author: "Neha Singh",
      date: "2024-01-08",
      readTime: "8 min read",
    ...
    },
    {
      ...
      excerpt:
        "Learn advanced Google Ads optimization techniques to improve your ad performance and reduce costs.",
    ...
    },
    {
      ...
      excerpt:
        "A comprehensive guide to creating and executing a successful content marketing strategy for your business.",
      author: "David Wilson",
      date: "2024-01-03",
      readTime: "12 min read",
      category: "Content Marketing",
      image: "/placeholder.svg", // ← updated from .png to .svg
    },
  ];
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            marketing from our expert team.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <button className="px-8 py-3 text-white font-semibold rounded-lg bg-gradient-to-r from-[#EA2525] to-[#AA2526] hover:from-[#AA2526] hover:to-[#EA2525] transition-colors">
            Load More Posts
          </button>
        </div>
      </div>
