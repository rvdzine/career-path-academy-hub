    ...
    <footer className="bg-gray-900 dark:bg-gray-950 text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 dark:text-gray-500">
              <li><Link href="/courses" className="hover:text-white transition-colors">Foundation in Digital Marketing</Link></li>
              <li><Link href="/courses" className="hover:text-white transition-colors">Specialist in Digital Marketing</Link></li>
              <li><Link href="/courses" className="hover:text-white transition-colors">Master in Digital Marketing</Link></li>
              <li><Link href="/courses" className="hover:text-white transition-colors">Professional & Business Owner Course</Link></li>
              <li><Link href="/courses" className="hover:text-white transition-colors">Degree in Digital Marketing</Link></li>
              <li><Link href="/courses" className="hover:text-white transition-colors">Diploma in Digital Marketing</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t flex justify-between border-gray-800 dark:border-gray-700 mt-12 pt-8 text-gray-400 dark:text-gray-500">
          ...
          <a href='https://cybershieldtechnologies.com/' target="_blank" rel="noopener noreferrer"><img src={typeof csh_footer === 'string' ? csh_footer : csh_footer.src} className="h-10 w-auto" alt="Cybershield Technologies" /></a>
        </div>
      </div>
    </footer>
  );
