...
export default function PlacedStudentsPage() {
  ...
  const handleManagePlacedStudents = () => {
    window.open('/admin/placed-students', '_blank');
  };
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between max-w-4xl mx-auto">
            ...
            <Button
              ...
              variant="outline"
              className="w-full md:w-auto bg-red-600 text-white hover:bg-red-700 hover:text-white border-red-600"
            >
